...
//	public int foundationSemesters;
	...
	public sysOption(){
		bachelors=new HashMap<Integer,String>();
	};
...
//		this.foundationSemesters=o.getFoundationSemesters();
	...
	public void setUniInfo(BachelorCourse bc){
		this.universityId=bc.getUniversityId();
		this.universityName=bc.getUniversityName();
	}
	public void addBachelorCourse(BachelorCourse bc){
		this.bachelors.put(bc.getCourseId(), bc.getName());
	}
